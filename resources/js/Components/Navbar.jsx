                    ...
                    {url === '/mjs' ? (
                        ...
                        <div className="hidden md:flex items-center gap-2">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-gradient-to-r from-[#003C8F] to-blue-700 hover:from-blue-700 hover:to-indigo-900 text-white text-xs sm:text-sm font-extrabold shadow-md hover:shadow-lg shadow-blue-900/40 hover:scale-105 transition-all duration-300 border border-white/20"
                        ...
                        {url !== '/mjs' ? (
                            <div className="pt-2 border-t border-white/10 space-y-2">
                                <a
                                    ...
                                    className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-[#003C8F] to-blue-700 text-white text-xs font-extrabold shadow-md border border-white/20 transition-all duration-300"
                                >
                                    <svg className="w-4 h-4 text-amber-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
