...
export default function PlataformaMobileButton() {
    ...
    return (
        <div 
            className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-[99999] md:hidden select-none pointer-events-auto transition-all duration-500 ${
        ...
        >
            <a
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-full bg-[#800A15] hover:bg-[#9e0d1c] text-white text-xs font-extrabold shadow-[0_10px_25px_rgba(128,10,21,0.55)] border border-white/20 active:scale-95 transition-all duration-300"
            >
