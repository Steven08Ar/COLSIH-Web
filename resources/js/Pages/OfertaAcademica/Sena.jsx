...
export default function Sena() {
    return (
        <AppLayout>
            ...
            <section className="relative pt-36 pb-32 md:pt-44 md:pb-40 bg-gradient-to-b from-[#1C0D02] via-[#0F172A] to-[#08111F] overflow-hidden select-none">
                {/* Blobs luminosos de color naranja SENA */}
                <div className="absolute top-1/3 left-1/4 -translate-y-1/2 w-[450px] h-[450px] bg-orange-500/20 rounded-full blur-[130px] pointer-events-none z-0"></div>
                <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[400px] h-[400px] bg-amber-500/10 rounded-full blur-[120px] pointer-events-none z-0"></div>
