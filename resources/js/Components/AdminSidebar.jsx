                                ...
                                return (
                                    <div key={itemIdx} className="relative space-y-1">
                                        ...
                                        <button
                                            ...
                                            onMouseLeave={() => isCollapsed && setActivePopover(null)}
                                        ...
                                        >
                                            <div className="flex items-center gap-3 min-w-0">
                                                <GroupIcon className={`w-4 h-4 shrink-0 ${hasActiveSubItem ? 'text-[#800A15] dark:text-blue-400' : 'text-slate-500 dark:text-slate-400'}`} />
                                                {!isCollapsed && <span className="truncate">{item.label}</span>}
                                            </div>
                                                    ...
                                                    return (
                                                        <Link
                                                            ...
                                                            className={`flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition-all duration-150 ${
                                                                isSubActive
                                                                    ? 'bg-[#800A15] text-white font-bold shadow-sm'
                                                        ...
                                                        >
                                                            ...
                                                            {sub.count !== undefined && sub.count !== null && (
                                                                <span className={`text-[9px] font-bold px-1.5 py-0.2 rounded ${
                                                                    isSubActive ? 'bg-white/20 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'
                                                                }`}>
                                                                    {sub.count}
                                                                </span>
                                                            )}
                                        ...
                                        {/* Popover Flotante en estado Colapsado (Figma mockup style) */}
                                        {isCollapsed && activePopover === item.groupKey && (
                                            <div 
                                                onMouseEnter={() => setActivePopover(item.groupKey)}
                                                onMouseLeave={() => setActivePopover(null)}
                                                className="absolute left-full ml-3 top-0 w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-2 z-50 space-y-1 animate-fadeIn"
                                            >
                                                    ...
                                                    return (
                                                        <Link
                                                            ...
                                                            className={`flex items-center justify-between px-3 py-2 rounded-xl text-xs font-medium transition-all ${
                                                                isSubActive
                                                                    ? 'bg-[#800A15] text-white font-bold'
                                                        ...
                                                        >
                                                            ...
                                                            {sub.count !== undefined && sub.count !== null && (
                                                                <span className="text-[9px] font-bold px-1.5 py-0.2 bg-slate-100 dark:bg-slate-800 text-slate-400 rounded">
                                                                    {sub.count}
                                                                </span>
                                                            )}
                                                        </Link>
