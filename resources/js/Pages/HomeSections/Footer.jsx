    ...
    return (
        <footer id="site-footer" className="relative bg-[#08111F] text-white overflow-hidden border-t border-white/5 select-none">
            ...
            <div className="max-w-[1680px] mx-auto px-6 md:px-12 lg:px-[120px] pt-16 md:pt-20 pb-6 md:pb-8 space-y-12 md:space-y-14">
                ...
                {/* Bottom Footer: Copyright, Social Links & Firma WEB */}
                <div className="pt-8 border-t border-white/5 space-y-2 sm:space-y-3">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 font-sans text-xs text-slate-400">
                    ...
                    {/* Firma WEB Centrada pegada al copyright */}
