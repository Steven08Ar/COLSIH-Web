                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    <div className="relative flex justify-center">
                        <ScrollReveal distance="translate-y-12" className="relative w-full max-w-[540px]">
                            ...
                            <div className="absolute inset-4 translate-x-4 translate-y-4 border border-[#001659]/20 rounded-2xl -z-10"></div>
                    ...
                    <div className="space-y-8 lg:space-y-12 text-center lg:text-left w-full min-w-0 flex flex-col items-center lg:items-start">
                            ...
                            {links.map((link) => (
                                ...
                                >
                                    <div className="flex items-baseline gap-4 sm:gap-6 min-w-0">
                                        <span className="text-sm font-extrabold text-[#001659] tracking-wider font-sans shrink-0">
                                            {link.num}
                                        </span>
                                        <div className="space-y-1 min-w-0">
                                            <h4 className="font-extrabold text-[16px] sm:text-[18px] text-[#08111F] group-hover:text-[#001659] transition-colors duration-300">
                                                {link.title}
                                            </h4>
                        ...
                        <ScrollReveal distance="translate-y-6" delay={400}>
                            <Link
                                href="/nosotros"
                                className="inline-flex items-center gap-2 bg-[#08111F] hover:bg-[#001659] text-white font-extrabold text-xs uppercase tracking-wider px-8 py-4 rounded-xl transition-all shadow-sm active:scale-[0.98] cursor-pointer"
                            >
                                Conocer más
