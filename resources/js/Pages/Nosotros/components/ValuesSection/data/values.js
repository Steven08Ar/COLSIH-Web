export const valoresCategories = [
    { id: 'todos', label: 'Todos los Valores' },
    { id: 'Espiritual', label: 'Dimensión Espiritual' },
    { id: 'Social', label: 'Dimensión Social y Comunitaria' },
    { id: 'Humano', label: 'Dimensión Humana y Ética' },
    { id: 'Pedagógico', label: 'Dimensión de Innovación y Cuidado' }
];
